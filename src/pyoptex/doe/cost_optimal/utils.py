...
Parameters = namedtuple('Parameters', 'fn max_cost colstart coords ratios effect_types grouped_cols prior Y2X')
State = namedtuple('State', 'Y X Zs Vinv metric cost_Y costs')
